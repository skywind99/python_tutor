...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    id: 2, unitId: 1,
    title: "사칙연산",
    level: 1, icon: "calculator", topic: "변수 · 연산자",
...
export const UNITS = [
  { id: 1, title: "출력과 변수", icon: "terminal-2", description: "파이썬의 시작! 화면에 출력하고 변수에 값을 저장해요.", missionIds: [1, 2] },
  { id: 2, title: "조건문", icon: "git-branch", description: "상황에 따라 다르게 동작하는 코드를 작성해요.", missionIds: [3, 4] },
  { id: 3, title: "반복문", icon: "refresh", description: "같은 동작을 반복하거나 패턴을 만들어요.", missionIds: [5, 6, 7] },
  { id: 4, title: "함수", icon: "math-function", description: "코드를 재사용할 수 있는 함수를 만들어요.", missionIds: [8] },
  { id: 5, title: "리스트", icon: "list", description: "여러 값을 한꺼번에 다루는 리스트를 배워요.", missionIds: [9] },
  { id: 6, title: "심화 미션", icon: "flame", description: "배운 것을 모두 활용하는 도전 미션!", missionIds: [10, 11, 12, 13, 14, 15] },
]
